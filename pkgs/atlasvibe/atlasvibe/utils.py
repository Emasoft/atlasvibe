...
import base64
from .CONSTANTS import ATLASVIBE_DIR, ATLASVIBE_CACHE_DIR, CREDENTIAL_FILE
...
def get_hf_hub_cache_path() -> str:
    """Returns the path to the HuggingFace home directory (HF_HOME) within the Atlasvibe cache directory
    This is used to cache huggingface artifacts within the Atlasvibe cache directory."""
    return os.path.join(ATLASVIBE_CACHE_DIR, "cache", "huggingface")
...
def set_offline():
    ...
    """
    AtlasvibeConfig.get_instance().is_offline = True
...
def set_online():
    ...
    """
    AtlasvibeConfig.get_instance().is_offline = False
...
class PlotlyJSONEncoder(_json.JSONEncoder):
    ...
    def encode(self, o: Any):
        ...
        try:
            ...
            raise ValueError(
                "Encoding into strict JSON failed. Did you set the separators valid JSON separators?"
            )
        else:
            return _json.dumps(
                new_o,
