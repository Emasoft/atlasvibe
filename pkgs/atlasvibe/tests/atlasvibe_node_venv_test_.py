...
def test_run_in_venv_streams_logs_to_http_server(
    ...
    assert "atlasvibe" in post_data_str
...
# Skip until dependency versions can be resolved with Atlasvibe (incompatible pandas versions)
