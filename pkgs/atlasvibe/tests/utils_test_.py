...
def temp_cache_dir():
    ...
    _test_tempdir = os.path.join(tempfile.gettempdir(), "test_atlasvibe_hf_hub_cache")
...
# @patch("atlasvibe.utils.hf_hub_download")
# @patch("atlasvibe.utils.get_hf_hub_cache_path")
...
#     )
#     from atlasvibe import hf_hub_download
#
...
#     """Test that the original hf_hub_download writes the file to the right place in atlasvibe cache"""
#     mock_get_hf_hub_cache_path.return_value = temp_cache_dir
#     # from atlasvibe import hf_hub_download
#     #
