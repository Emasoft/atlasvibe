...
var Tt = (o, t, e) =>
  t in o
    ? bt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (o[t] = e);
var F = (o, t, e) => (Tt(o, typeof t != "symbol" ? t + "" : t, e), e);
import {
  u as St,
  r as $,
  d as kt,
  ...
  b as Ft,
  c as At,
} from "./assets/testServerConnection-tvl--fIL.js";
var Wt = {};
class nt {
  constructor(t, e) {
    (this._tests = new Map()),
      (this._rootSuite = new U("", "root")),
      (this._options = e),
      (this._reporter = t);
  }
  reset() {
  ...
  _onTestEnd(t, e) {
    ...
    const i = s._resultsMap.get(e.id);
  ...
  _onStepBegin(t, e, s) {
    ...
    const i = this._tests.get(t),
      l = i._resultsMap.get(e),
      a = s.parentStepId ? l._stepMap.get(s.parentStepId) : void 0,
      f = this._absoluteLocation(s.location),
      n = new Ut(s, a, f);
    a ? a.steps.push(n) : l.steps.push(n),
      l._stepMap.set(s.id, n),
      (d = (m = this._reporter).onStepBegin) == null || d.call(m, i, l, n);
  }
  _onStepEnd(t, e, s) {
    var f, n;
    const i = this._tests.get(t),
    ...
    (a.duration = s.duration),
      (a.error = s.error),
      (n = (f = this._reporter).onStepEnd) == null || n.call(f, i, l, a);
  }
  _onError(t) {
    var e, s;
  ...
  _onStdIO(t, e, s, i, l) {
    ...
    const a = l ? (globalThis.Buffer ? Buffer.from(i, "base64") : atob(i)) : i,
      ...
      n = f && s ? f._resultsMap.get(s) : void 0;
    t === "stdout"
      ? (n == null || n.stdout.push(a),
        (d = (m = this._reporter).onStdOut) == null || d.call(m, a, f, n))
  ...
  _mergeSuitesInto(t, e) {
    for (const s of t) {
      let i = e.suites.find((l) => l.title === s.title);
      i ||
        ((i = new U(s.title, e._type === "project" ? "file" : "describe")),
        (i.parent = e),
        e.suites.push(i)),
  ...
  _mergeTestsInto(t, e) {
    for (const s of t) {
      let i = this._options.mergeTestCases
        ? e.tests.find(
            (l) =>
              l.title === s.title && l.repeatEachIndex === s.repeatEachIndex,
          )
        : void 0;
      i ||
        ((i = new Ot(
          s.testId,
          s.title,
          this._absoluteLocation(s.location),
          s.repeatEachIndex,
        )),
        (i.parent = e),
        e.tests.push(i),
  ...
  _absolutePath(t) {
    if (t !== void 0) return this._options.resolvePath(this._rootDir, t);
  }
}
class U {
  constructor(t, e) {
...
class Ot {
  ...
  _createTestResult(t) {
    const e = new zt(this.results.length);
    return this.results.push(e), this._resultsMap.set(t, e), e;
  }
}
class Ut {
  constructor(t, e, s) {
...
function Q(o) {
  return o.map((t) => (t.s ? t.s : new RegExp(t.r.source, t.r.flags)));
}
class at {
  constructor(t, e, s, i, l) {
    ...
    const f = (n, m, d) => {
      for (const g of m.suites) {
        ...
        let c = d.children.find((p) => p.kind === "group" && p.title === k);
        c ||
          ((c = {
            kind: "group",
            subKind: "describe",
      ...
      for (const g of m.tests) {
        const k = g.title;
        let c = d.children.find((I) => I.kind !== "group" && I.title === k);
        c ||
          ((c = {
            kind: "case",
        ...
        this._addChild(c, y),
          this._treeItemByTestId.set(g.id, y),
          (c.duration = c.children.reduce((I, S) => I + S.duration, 0));
      }
    };
    ...
    for (const n of s) {
      ...
      const m = this._fileItem(n.location.file.split(l), !0);
      m.hasLoadErrors = !0;
    }
  }
  _addChild(t, e) {
  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(" "),
      ...
      a = (n) => {
        const m = [...n.tests[0].titlePath(), ...n.tests[0].tags]
          .join(" ")
          .toLowerCase();
        return !i.every((d) => m.includes(d)) &&
          !n.tests.some((d) => (s == null ? void 0 : s.has(d.id)))
          ? !1
          : ((n.children = n.children.filter(
            ...
            (n.tests = n.children.map((d) => d.test)),
            !!n.children.length);
      },
      f = (n) => {
        const m = [];
        for (const d of n.children)
          d.kind === "case"
            ? a(d) && m.push(d)
            : (f(d), (d.children.length || d.hasLoadErrors) && m.push(d));
        n.children = m;
      };
    f(this.rootItem);
  }
  ...
  collectTestIds(t) {
    return t ? Vt(t) : new Set();
  }
}
function ht(o) {
  for (const a of o.children) ht(a);
  o.kind === "group" &&
    o.children.sort(
      (a, f) =>
        a.location.file.localeCompare(f.location.file) ||
        a.location.line - f.location.line,
    );
...
class $t {
  constructor(t) {
    ...
    F(this, "_options");
    (this._receiver = new nt(this._createReporter(), {
      mergeProjects: !0,
      mergeTestCases: !0,
  ...
  processListReport(t) {
    ...
    for (const e of t) this._receiver.dispatch(e);
  }
  ...
  asModel() {
    return {
      rootSuite: this.rootSuite || new U("", "root"),
      config: this.config,
...
const qt = ({ source: o }) => {
    const [t, e] = St(),
      ...
      [l] = $.useState(
        jt(
          () => import("./assets/xtermModule-Yt6xwiJ_.js"),
          __vite__mapDeps([0, 1]),
          import.meta.url,
        ).then((f) => f.default),
      ),
        ...
        return (
          (async () => {
            ...
            const c = new m({
              ...
              p = new d();
            c.loadAddon(p);
            for (const x of o.pending) c.write(x);
            (o.write = (x) => {
              o.pending.push(x), c.write(x);
            }),
              (o.clear = () => {
                (o.pending = []), c.clear();
              }),
              c.open(g),
              p.fit(),
              (a.current = { terminal: c, fitAddon: p });
          })(),
          () => {
            (o.clear = n), (o.write = f);
          }
  ...
  et = navigator.userAgent.toLowerCase().includes("windows") ? "\\" : "/",
  Qt = ({
    title: o,
    children: t,
    setExpanded: e,
    ...
    r.jsxs("div", {
      ...
      children: [
        ...
        s && r.jsx("div", { style: { marginLeft: 25 }, children: t }),
      ],
    }),
  Xt = ({
    filterText: o,
...
Projects: ` +
  ...
  Jt = ({ tag: o, style: t, onClick: e }) =>
    r.jsx("span", {
      className: `tag tag-color-${Zt(o)}`,
      onClick: e,
...
const Gt = Bt,
  te = ({
    ...
    const [c, p] = h.useState({ expandedItems: new Map() }),
      [x, y] = h.useState(),
      [I, S] = h.useState(g);
    h.useEffect(() => {
      if (I !== g) {
        c.expandedItems.clear();
        for (const b of s.flatTreeItems()) c.expandedItems.set(b.id, !1);
        S(g), y(void 0), p({ ...c });
        return;
      }
      ...
      const j = (b) => {
        ...
        b.children.forEach(j),
          !u &&
            b.status === "failed" &&
            ((b.kind === "test" && l.testIds.has(b.test.id)) ||
              (b.kind === "case" &&
                l.testIds.has((C = b.tests[0]) == null ? void 0 : C.id))) &&
            (u = b);
      };
      j(s.rootItem), u && y(u.id);
    }, [l, y, s, I, S, g, c, p]);
    const { selectedTreeItem: z } = h.useMemo(() => {
      if (!t) return { selectedTreeItem: void 0 };
      const u = x ? s.treeItemById(x) : void 0;
      let j;
      u &&
        (j = {
          ...
          source: {
            errors: t.loadErrors
              .filter((C) => {
                var q;
                return (
                  ((q = C.location) == null ? void 0 : q.file) ===
                  u.location.file
                );
              })
      ...
      return (
        (u == null ? void 0 : u.kind) === "test"
          ...
          : (u == null ? void 0 : u.kind) === "case" &&
            u.tests.length === 1 &&
            (b = u.tests[0]),
        d({ treeItem: u, testCase: b, testFile: j }),
        { selectedTreeItem: u }
      );
    }, [d, x, t, s]);
    h.useEffect(() => {
    ...
    const A = (u) => {
        y(u.id), i("bounce-if-busy", s.collectTestIds(u));
      },
      J = (u, j) => {
    ...
    return r.jsx(Gt, {
        ...
        r.jsxs("div", {
          ...
          children: [
            r.jsxs("div", {
              ...
              children: [
                r.jsx("span", { title: u.title, children: u.title }),
                u.kind === "case"
                  ? u.tags.map((j) =>
                      r.jsx(
                        Jt,
                        { tag: j.slice(1), onClick: (b) => J(b, j) },
                        j,
                      ),
                    )
                  : null,
              ...
              children: [
                ...
                r.jsx(N, {
                  ...
                  onClick: () =>
                    e == null
                      ? void 0
                      : e.openNoReply({ location: u.location }),
                  style:
      ...
      onAccepted: A,
      onSelected: (u) => {
        l && (l.itemSelectedByUser = !0), y(u.id);
      },
...
const se = ({ item: o, rootDir: t }) => {
    var k;
    const [e, s] = h.useState(),
      [i, l] = h.useState(0),
      a = h.useRef(null),
      { outputDir: f } = h.useMemo(
        () => ({ outputDir: o.testCase ? ie(o.testCase) : void 0 }),
        [o],
      ),
      [n, m] = h.useState(),
      d = h.useCallback((c) => m(rt(c)), [m]),
      g = n
        ? e == null
          ? void 0
          : e.model.actions.find((c) => rt(c) === n)
        : void 0;
    return (
      h.useEffect(() => {
        var y, I;
        a.current && clearTimeout(a.current);
        const c = (y = o.testCase) == null ? void 0 : y.results[0];
        if (!c) {
          s(void 0);
          return;
        }
        const p =
          c && c.duration >= 0 && c.attachments.find((S) => S.name === "trace");
        if (p && p.path) {
          lt(p.path).then((S) => s({ model: S, isLive: !1 }));
          return;
        }
        if (!f) {
          s(void 0);
        ...
        const x = `${f}/${ee(c.workerIndex)}/traces/${(I = o.testCase) == null ? void 0 : I.id}.json`;
        return (
      ...
      r.jsx(
        Ct,
        {
          ...
          status: (k = o.treeItem) == null ? void 0 : k.status,
        },
        "workbench",
      )
    );
...
const P = {
  ...
  ut = navigator.platform === "MacIntel",
  re = ({}) => {
    var ot;
    const [o, t] = h.useState(""),
      [e, s] = h.useState(!1),
      [i, l] = h.useState(
        new Map([
          ["passed", !1],
      ...
      _t = h.useRef(null),
      Y = h.useCallback(() => {
        wt(new Mt(ft.toString()));
      }, []);
    h.useEffect(() => {
      var v;
      (v = _t.current) == null || v.focus(), I(!0), Y();
    }, [Y]),
      h.useEffect(() => {
        if (!_) return;
        const v = [
        ...
        return (
          (W.resize = (w, E) => {
            (ct = { cols: w, rows: E }),
              _.resizeTerminalNoReply({ cols: w, rows: E });
          }),
          () => {
            for (const w of v) w.dispose();
          }
        );
      }, [_]),
      h.useEffect(() => {
...
`,
          ...
          E = async () => {
            b.current = b.current.then(async () => {
              I(!0);
              try {
                const T = await _.listTests({
                  projects: P.projects,
                  locations: P.args,
                });
                w.processListReport(T.report);
              } catch (T) {
                console.log(T);
              } finally {
                I(!1);
        ...
        return (
          ...
          j({ value: new Set() }),
          (async () => {
            await _.initialize({ interceptStdio: !0, watchTestDirs: !0 });
            const { status: T } = await _.runGlobalSetup({});
            if (T !== "passed") return;
            const B = await _.listTests({
              projects: P.projects,
              locations: P.args,
            });
            w.processListReport(B.report),
              _.onListChanged(E),
              _.onReport((L) => {
                w.processTestReportEvent(L);
              }),
              I(!1);
            const { hasBrowsers: R } = await _.checkBrowsers({});
            it(R);
          })(),
          () => {
            clearTimeout(v);
      ...
      h.useEffect(() => {
        if (!n) return;
        const { config: v, rootSuite: w } = n,
          E = v.configFile
            ? dt.getObject(v.configFile + ":projects", void 0)
            : void 0,
          T = new Map(a);
        for (const B of T.keys())
          w.suites.find((R) => R.title === B) || T.delete(B);
        for (const B of w.suites)
          T.has(B.title) ||
            T.set(B.title, !!(E != null && E.includes(B.title)));
        !E &&
          T.size &&
          ![...T.values()].includes(!0) &&
          T.set(T.entries().next().value[0], !0),
          (a.size !== T.size || [...a].some(([B, R]) => T.get(B) !== R)) &&
            f(T);
      }, [a, n]),
      h.useEffect(() => {
        S && n != null && n.progress ? g(n.progress) : n || g(void 0);
      }, [n, S]);
    const { testTree: K } = h.useMemo(() => {
        if (!n) return { testTree: new at("", new U("", "root"), [], a, et) };
        const v = new at("", n.rootSuite, n.loadErrors, a, et);
        return (
          v.filterTree(o, i, S == null ? void 0 : S.testIds),
      ...
      O = h.useCallback(
        (v, w) => {
          !_ ||
            !n ||
            (v === "bounce-if-busy" && S) ||
            ((C.current = new Set([...C.current, ...w])),
            (b.current = b.current.then(async () => {
              var B, R, L;
              const E = C.current;
              if (((C.current = new Set()), !E.size)) return;
              {
                for (const D of ((B = n.rootSuite) == null
                  ? void 0
                  : B.allTests()) || [])
                  if (E.has(D.id)) {
                    D._clearResults();
                    const tt = D._createTestResult("pending");
                    tt[H] = "scheduled";
                  }
                m({ ...n });
              }
              ...
              W.write(
                "\x1B[2m—".repeat(Math.max(0, ct.cols - T.length)) +
                  T +
                  "\x1B[22m",
              ),
                ...
                await _.runTests({
                  ...
                  testIds: [...E],
                  projects: [...a].filter(([D, tt]) => tt).map(([D]) => D),
                  workers: P.workers,
                  timeout: P.timeout,
                  headed: P.headed,
              ...
              for (const D of ((R = n.rootSuite) == null
                ? void 0
                : R.allTests()) || [])
                ((L = D.results[0]) == null ? void 0 : L.duration) === -1 &&
                  D._clearResults();
              m({ ...n }), z(void 0);
            })));
        },
    ...
    h.useEffect(() => {
      if (!_) return;
      const v = _.onTestFilesChanged((w) => {
        const E = [],
          T = new Set(w.testFiles);
        if (A) {
          const B = (R) => {
            const L = R.location.file;
            L && T.has(L) && E.push(...K.collectTestIds(R)),
              R.kind === "group" &&
                R.subKind === "folder" &&
          ...
          for (const B of u.value) {
            const R = K.treeItemById(B),
              L = R == null ? void 0 : R.location.file;
            L && T.has(L) && E.push(...K.collectTestIds(R));
          }
        O("queue-if-busy", new Set(E));
      });
      return () => v.dispose();
    }, [O, _, K, A, u]),
      h.useEffect(() => {
        ...
        const v = (w) => {
          w.code === "Backquote" && w.ctrlKey
            ...
            : w.code === "F5" && w.shiftKey
              ? (w.preventDefault(), _ == null || _.stopTestsNoReply({}))
              : w.code === "F5" && (w.preventDefault(), O("bounce-if-busy", p));
        };
        return (
      ...
      xt = h.useCallback(
        (v) => {
          G(v),
            s(!0),
            _ == null ||
              _.installBrowsers({}).then(async () => {
                s(!1);
                const { hasBrowsers: w } = await (_ == null
                  ? void 0
                  : _.checkBrowsers({}));
                it(w);
              });
              ...
              children: [
                ...
                r.jsx("div", {
                  ...
                  children: r.jsx(se, {
                    item: k,
                    rootDir:
                      (ot = n == null ? void 0 : n.config) == null
                        ? void 0
                        : ot.rootDir,
                  }),
                }),
                ...
                r.jsxs(X, {
                  ...
                  children: [
                    ...
                    r.jsx(N, {
                      icon: "play",
                      title: "Run all — F5",
                      onClick: () => O("bounce-if-busy", p),
                      disabled: V || y,
                    }),
                    r.jsx(N, {
                      icon: "debug-stop",
                      title: "Stop — " + (ut ? "⇧F5" : "Shift + F5"),
                      onClick: () => (_ == null ? void 0 : _.stopTests({})),
                      disabled: !V || y,
                    }),
                    r.jsx(N, {
                      icon: "eye",
...
Make sure to serve the website (${window.location}) via HTTPS or localhost.`);
  ...
  At.render(r.jsx(re, {}), document.querySelector("#root"));
})();
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = [
      "./assets/xtermModule-Yt6xwiJ_.js",
      "./xtermModule.0lwXJFHT.css",
    ];
  }
