...
test.describe("Block Operations on Flowchart", () => {
  ...
  test("Add multiple blueprint blocks creates custom blocks with incrementing default suffixed names", async () => {
    ...
    const paletteBlock = page.locator(
      blockPaletteSelectors.blockByTestId(blueprintKey),
    );
    ...
    const firstNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(expectedFirstName),
    );
    ...
    const secondNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(expectedSecondName),
    );
    ...
    // Add third block
    await paletteBlock.dragTo(page.locator(Selectors.flowchartCanvas), {
      targetPosition: { x: 50, y: 250 },
    });
    const thirdNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(expectedThirdName),
    );
  ...
  test("Rename a custom block successfully", async () => {
    ...
    await paletteBlock.dragTo(page.locator(Selectors.flowchartCanvas));
    const nodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(initialName),
    );
    ...
    await page
      .locator(Selectors.flowchartCanvas)
      .click({ position: { x: 0, y: 0 } }); // Blur to apply

    const renamedNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(newName),
    );
  ...
  test("Rename a block to an empty string should revert to original name", async () => {
    ...
    const currentNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(initialName),
    );
  ...
  test("Rename a block to a name with special characters", async () => {
    ...
    const finalNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(specialName),
    );
  ...
  test("Rename collision with a blueprint key should result in suffixed name", async () => {
    ...
    const finalNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(expectedSuffixedName),
    );
  ...
  test("Rename collision with an existing custom block name should result in suffixed name", async () => {
    ...
    const paletteBlock1 = page.locator(
      blockPaletteSelectors.blockByTestId(blueprintKey1),
    );
    await paletteBlock1.dragTo(page.locator(Selectors.flowchartCanvas), {
      targetPosition: { x: 50, y: 50 },
    });
    const paletteBlock2 = page.locator(
      blockPaletteSelectors.blockByTestId(blueprintKey2),
    );
    await paletteBlock2.dragTo(page.locator(Selectors.flowchartCanvas), {
      targetPosition: { x: 50, y: 150 },
    });

    const block1Label = page.locator(
      flowchartSelectors.nodeLabelByName(block1InitialName),
    );
    const block2Label = page.locator(
      flowchartSelectors.nodeLabelByName(block2InitialName),
    );
    ...
    const finalNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(expectedSuffixedNameAfterCollision),
    );
    await expect(finalNodeLabel).toBeVisible({ timeout: 5000 });
  ...
  test("Rename block, then rename another block to the original name of the first", async () => {
    ...
    // Add CONSTANT_1
    await page
      .locator(blockPaletteSelectors.blockByTestId(constBlueprintKey))
      .dragTo(page.locator(Selectors.flowchartCanvas), {
        targetPosition: { x: 50, y: 50 },
      });
    const constNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(constBlockOriginalName),
    );
    ...
    await page
      ...
      .click({ position: { x: 0, y: 0 } });
    await expect(
      page.locator(flowchartSelectors.nodeLabelByName(constBlockNewName)),
    ).toBeVisible();
    await expect(constNodeLabel).not.toBeVisible(); // CONSTANT_1 is gone

    // Add ADD_1
    await page
      .locator(blockPaletteSelectors.blockByTestId(addBlueprintKey))
      .dragTo(page.locator(Selectors.flowchartCanvas), {
        targetPosition: { x: 50, y: 150 },
      });
    const addNodeLabel = page.locator(
      flowchartSelectors.nodeLabelByName(addBlockOriginalName),
    );
    ...
    await expect(
      page.locator(flowchartSelectors.nodeLabelByName(constBlockOriginalName)),
    ).toBeVisible();
