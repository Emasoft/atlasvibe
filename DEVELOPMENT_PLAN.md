...
- **Details:**
  ...
  - The concept of globally importing a "custom blocks folder" will be removed. The project's block directory _is_ the custom blocks source for that project.
- **Implementation:**
...
- **Implementation:**
  ...
  - **Import Namespace Fix:**
    ...
    - Fixed **build_class** missing in custom builtins
