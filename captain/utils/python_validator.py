...
class PythonValidator:
    ...
    def __init__(self, project_path: Optional[Path] = None):
        ...
        self.atlasvibe_imports = {
            "atlasvibe", "atlasvibe_sdk", "DataContainer", "Scalar", 
            "Vector", "Matrix", "DataFrame", "OrderedPair", "Surface"
        }
        ...
        for import_info in visitor.imports:
            ...
            if not self._can_import(module_name):
                errors.append(ValidationError(
                    ...
                    severity="error",
                    category="import",
                    suggestion=f"Install the package or check the module name"
                ))
    ...
    def _validate_atlasvibe_decorator(self, tree: ast.AST, code: str) -> List[ValidationError]:
        ...
        atlasvibe_funcs = [f for f in visitor.decorated_functions 
    ...
    def _can_import(self, module_name: str) -> bool:
        ...
        if module_name.startswith("atlasvibe"):
            return True
...
def validate_python_code(code: str, filename: str = "<unknown>", 
