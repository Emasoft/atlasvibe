...
class CodeIntelligence:
    ...
    def _init_builtin_completions(self):
        ...
        for kw in keywords:
            self.builtin_completions.append(CompletionItem(
                label=kw,
                kind="keyword",
                insert_text=kw,
    ...
    def get_completions(self, code: str, line: int, column: int, 
                       trigger_char: Optional[str] = None) -> List[CompletionItem]:
    ...
    def _get_member_completions(self, context: "CompletionContext") -> List[CompletionItem]:
        ...
        if context.object_name == "np":
            ...
            numpy_funcs = [
                ...
                "dot", "cross", "transpose", "reshape", "concatenate"
            ]
    ...
    def _get_type_completions(self, context: "CompletionContext") -> List[CompletionItem]:
        ...
        types = [
            ...
            "Scalar", "Vector", "Matrix", "DataFrame", "OrderedPair", "Surface"
        ]
...
def get_hover_info(code: str, line: int, column: int,
                  project_path: Optional[str] = None) -> Optional[Dict[str, Any]]:
