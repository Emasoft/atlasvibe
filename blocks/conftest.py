...
def mock_atlasvibe_node_decorator():
    ...
    with patch("pkgs.atlasvibe.atlasvibe.atlasvibe_python.atlasvibe_node", side_effect=no_op_decorator), \
...
def mock_atlasvibe_venv_cache_directory(tmp_path):
    ...
    with patch("pkgs.atlasvibe.atlasvibe.CONSTANTS.ATLASVIBE_CACHE_DIR", str(cache_dir)), \
         patch("pkgs.atlasvibe.atlasvibe.atlasvibe_node_venv.ATLASVIBE_CACHE_DIR", str(cache_dir)):
        yield cache_dir
